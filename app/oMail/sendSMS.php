...
class sendSMS
{
     ...
     * @var string
     */
    protected $clientId = 'mPAWANdUekcudakKC8dd4qwk9ZYZxea1';
     ...
     * @var string
     */
    protected $clientSecret = 'ldrj4lTzYoJAkcOe';
     ...
     * @var string
     */
    protected $token = '65Q2q4gKGPNoPLmLNq1iAyllTYnF';
